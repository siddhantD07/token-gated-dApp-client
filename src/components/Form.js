...
const Form = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      phone: Yup.string()
        ...
        .required("Required"),
      homeAddress: Yup.string().max(250,"Word limit reached").required("Required"),
      ...
      stateProvince: Yup.string().max(100,"Word limit reached").required("Required"),
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >{
        formResult?(<Grid item xs={12}>
          <Typography variant="h4" component="h4" sx={{color:"White"}}>{formResult}</Typography>
        </Grid>):(
          ...
          >
            ...
            <Grid item xs={12}>
            {submitPressed?(submitPressed===1?(<CircularProgress color="neutral" />):null):(<Button
                variant="contained"
                type="submit"
                color= "neutral"
                sx={{
